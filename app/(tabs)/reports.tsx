    ...
    return (
      <View style={safeAreaStyles.container}>
        <View style={styles.emptyContainer}>
          <Ionicons name="bar-chart-outline" size={64} color="#475569" />
    ...
    <ScrollView style={safeAreaStyles.container}>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.overviewGrid}>
          ...
          <View style={styles.overviewCard}>
            <Ionicons name="cash-outline" size={24} color={remaining >= 0 ? "#10b981" : "#ef4444"} />
      ...
      <View style={styles.section}>
        ...
        {categorySpending.length === 0 ? (
          <View style={styles.emptyCategories}>
            <Ionicons name="albums-outline" size={40} color="#475569" />
            ...
            <View key={index} style={styles.categoryItem}>
              ...
              <View style={styles.categoryProgress}>
                  ...
                  <View
                    style={[
                      styles.progressFill,
                      {
                        ...
                        backgroundColor: category.percentage > 100 ? "#ef4444" : category.percentage > 80 ? "#f59e0b" : "#10b981"
                      }
                    ]}
                  />
                </View>
                <Text style={[
                  ...
                  { color: category.percentage > 100 ? "#ef4444" : "#94a3b8" }
                ]}>
